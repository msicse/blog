...
<div class="container-fluid">
    ...
    <a href="{{ route('author.posts.index') }}" class="btn btn-danger waves-effect">
    ...
    @else
    <button type="button" class="btn btn-info waves-effect pull-right" disabled>
        <i class="material-icons">clear</i>
        <span>Not Apporved</span>
    </button>
    @endif
    <br>
    <br>

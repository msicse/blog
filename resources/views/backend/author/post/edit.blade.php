...
@section('title','Author | Post | Edit')
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <input type="checkbox" class="filled-in" id="ig_checkbox" name="publish" value="1" {{ $post->status == true ? 'checked' : ''}}>

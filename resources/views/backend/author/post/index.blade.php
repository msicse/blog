...
<div class="container-fluid">
    <div class="block-header">
        <a href="{{ route('author.posts.create') }}" class="btn btn-primary waves-effect " >
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('author.posts.show',$data->id) }}" class="btn btn-success waves-effect ">
                                            <i class="material-icons">visibility</i>
                                        </a>

                                        <a href="{{ route('author.posts.edit',$data->id) }}" class="btn btn-primary waves-effect ">
                                        ...
                                        <form id="delete-form-{{ $data->id }}" style="display: none;" action="{{  route('author.posts.destroy',$data->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
